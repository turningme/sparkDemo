...
public class ConsumerWithResult {
    ...
    public ConsumerWithResult(int consumerId) {
    ...
    public static final String TOPIC = "omega_log_monitor_result_t0";
    ...
    public static void test1(){
        ...
        ConsumerWithResult csm0 = new ConsumerWithResult(1);
